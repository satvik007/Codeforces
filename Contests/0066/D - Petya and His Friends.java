...
public class Main {
    ...
    static class satvik {
        ...
        boolean bs[] = new boolean[1010];
        int primes[] = new int [1010];
        public void solve(int testNumber, InputReader in, BufferedWriter out) throws IOException {
            ...
            for(int i = 0; i < n; i++) {
                base = base.multiply(BigInteger.valueOf(primes[i]));
            }
            for(int i = 0; i < n; i++) {
                out.write(base.divide(BigInteger.valueOf(primes[i])).toString() + "\n");
            }
        }
